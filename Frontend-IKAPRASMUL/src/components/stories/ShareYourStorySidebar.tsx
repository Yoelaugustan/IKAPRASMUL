...
export function ShareYourStorySidebar() {
  return (
    <div className="rounded-2xl bg-[#00396c] p-8 shadow-lg">
      ...
      <Link
        href="#"
        className="mt-6 flex w-full items-center justify-center gap-2 rounded bg-[#c6b273] px-4 py-3 text-[13px] font-bold text-[#0a192f] transition-colors hover:bg-[#b4a05e]"
      >
