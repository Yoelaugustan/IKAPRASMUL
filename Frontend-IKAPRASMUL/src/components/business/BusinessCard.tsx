  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col px-4 pb-5 pt-7">
        ...
        <h3
          className="mt-2.5 text-[15px] font-bold leading-snug text-slate-900 group-hover:text-primary notranslate"
          translate="no"
        >
          {business.name}
        </h3>
